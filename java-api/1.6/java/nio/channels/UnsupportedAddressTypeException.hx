...
/** @REF http://docs.oracle.com/javase/6/docs/api/java/nio/channels/UnsupportedAddressTypeException.html */
@:native("java.nio.channels.UnsupportedAddressTypeException")
