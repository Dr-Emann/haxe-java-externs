...
extern class SecureClassLoader extends ClassLoader
{
	...
	/*@@@ modifiers=20 */ @:overload(function (name:String, b:ByteBuffer, cs:CodeSource):Class<Dynamic> {})
	...
	/*@@@ modifiers=20 */ override public function defineClass(name:String, b:ByteBuffer, protectionDomain:ProtectionDomain):Class<Dynamic>;
