...
extern class Normalizer extends Object
{
	...
	/*@@@ modifiers=9 */ static public function isNormalized(src:CharSequence, form:Normalizer_Form):Bool;
	...
	/*@@@ modifiers=9 */ static public function normalize(src:CharSequence, form:Normalizer_Form):String;
