...
extern class CardLayout extends Object, implements LayoutManager2, implements Serializable
{
	...
	public function first(parent:Container):Void;
	...
	public function last(parent:Container):Void;
	...
	public function next(parent:Container):Void;
	...
	public function previous(parent:Container):Void;
	...
	public function show(parent:Container, name:String):Void;
