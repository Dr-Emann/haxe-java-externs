...
extern class CubicCurve2D extends Object, implements Shape, implements Cloneable
{
	...
	/** @REF http://docs.oracle.com/javase/6/docs/api/java/awt/geom/CubicCurve2D.html#getBounds2D() */
	...
	@:overload(function (x1:StdFloat, y1:StdFloat, ctrlx1:StdFloat, ctrly1:StdFloat, ctrlx2:StdFloat, ctrly2:StdFloat, x2:StdFloat, y2:StdFloat):StdFloat {})
	...
	@:overload(function (x1:StdFloat, y1:StdFloat, ctrlx1:StdFloat, ctrly1:StdFloat, ctrlx2:StdFloat, ctrly2:StdFloat, x2:StdFloat, y2:StdFloat):Void {})
	...
	@:overload(function (p1:Point2D, cp1:Point2D, cp2:Point2D, p2:Point2D):Void {})
	...
	public function setCurve(c:CubicCurve2D):Void;
	...
	static public function solveCubic(eqn:NativeArray<StdFloat>):Int;
	...
	@:overload(function (left:CubicCurve2D, right:CubicCurve2D):Void {})
	...
	static public function subdivide(src:CubicCurve2D, left:CubicCurve2D, right:CubicCurve2D):Void;
