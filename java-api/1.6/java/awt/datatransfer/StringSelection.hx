...
extern class StringSelection extends Object, implements Transferable, implements ClipboardOwner
{
	...
	/*@@@ modifiers=1 */ public function new(data:String):Void;
	...
	/*@@@ modifiers=1 */ public function getTransferData(flavor:DataFlavor):Dynamic;

	/** @REF http://docs.oracle.com/javase/6/docs/api/java/awt/datatransfer/StringSelection.html#getTransferDataFlavors() */
	/*@@@ modifiers=1 */ public function getTransferDataFlavors():NativeArray<DataFlavor>;
	...
	/*@@@ modifiers=1 */ public function isDataFlavorSupported(flavor:DataFlavor):Bool;
	...
	/*@@@ modifiers=1 */ public function lostOwnership(clipboard:Clipboard, contents:Transferable):Void;
