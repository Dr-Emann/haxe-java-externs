...
extern class SystemFlavorMap extends Object, implements FlavorMap, implements FlavorTable
{
	...
	/*@@@ modifiers=33 */ public function addFlavorForUnencodedNative(nat:String, flav:DataFlavor):Void;
	...
	/*@@@ modifiers=33 */ public function addUnencodedNativeForFlavor(flav:DataFlavor, nat:String):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/java/awt/datatransfer/SystemFlavorMap.html#decodeDataFlavor(java.lang.String) */
	/*@@@ modifiers=9 */ static public function decodeDataFlavor(nat:String):DataFlavor;
	...
	/*@@@ modifiers=9 */ static public function decodeJavaMIMEType(nat:String):String;
	...
	/*@@@ modifiers=9 */ static public function encodeDataFlavor(flav:DataFlavor):String;
	...
	/*@@@ modifiers=9 */ static public function encodeJavaMIMEType(mimeType:String):String;

	/** @REF http://docs.oracle.com/javase/6/docs/api/java/awt/datatransfer/SystemFlavorMap.html#getDefaultFlavorMap() */
	/*@@@ modifiers=9 */ static public function getDefaultFlavorMap():FlavorMap;
	...
	/*@@@ modifiers=33 */ public function getFlavorsForNative(nat:String):List<DataFlavor>;
	...
	/*@@@ modifiers=33 */ public function getFlavorsForNatives(natives:NativeArray<String>):Map<String, DataFlavor>;
	...
	/*@@@ modifiers=33 */ public function getNativesForFlavor(flav:DataFlavor):List<String>;
	...
	/*@@@ modifiers=33 */ public function getNativesForFlavors(flavors:NativeArray<DataFlavor>):Map<DataFlavor, String>;

	/** @REF http://docs.oracle.com/javase/6/docs/api/java/awt/datatransfer/SystemFlavorMap.html#isJavaMIMEType(java.lang.String) */
	/*@@@ modifiers=9 */ static public function isJavaMIMEType(str:String):Bool;
	...
	/*@@@ modifiers=33 */ public function setFlavorsForNative(nat:String, flavors:NativeArray<DataFlavor>):Void;
	...
	/*@@@ modifiers=33 */ public function setNativesForFlavor(flav:DataFlavor, natives:NativeArray<String>):Void;
