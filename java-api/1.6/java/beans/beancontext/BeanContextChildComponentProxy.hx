...
/** @REF http://docs.oracle.com/javase/6/docs/api/java/beans/beancontext/BeanContextChildComponentProxy.html */
@:native("java.beans.beancontext.BeanContextChildComponentProxy")
