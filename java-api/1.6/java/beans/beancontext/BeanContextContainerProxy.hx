...
/** @REF http://docs.oracle.com/javase/6/docs/api/java/beans/beancontext/BeanContextContainerProxy.html */
@:native("java.beans.beancontext.BeanContextContainerProxy")
