...
extern interface DGC implements Remote
{
	...
	public function clean(ids:NativeArray<ObjID>, sequenceNum:haxe.Int64, vmid:VMID, strong:Bool):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/java/rmi/dgc/DGC.html#dirty(java.rmi.server.ObjID[], long, java.rmi.dgc.Lease) */
	public function dirty(ids:NativeArray<ObjID>, sequenceNum:haxe.Int64, lease:Lease):Lease;
