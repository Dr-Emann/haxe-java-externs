...
extern class DirectoryManager extends NamingManager
{
	...
	/*@@@ modifiers=9 */ static public function getContinuationDirContext(cpe:CannotProceedException):DirContext;
	...
	/*@@@ modifiers=9 */ static public function getObjectInstance(refInfo:Dynamic, name:Name, nameCtx:Context, environment:Hashtable<Dynamic, Dynamic>, attrs:Attributes):Dynamic;
	...
	/*@@@ modifiers=9 */ static public function getStateToBind(obj:Dynamic, name:Name, nameCtx:Context, environment:Hashtable<Dynamic, Dynamic>, attrs:Attributes):DirStateFactory_Result;
