...
extern class InitialLdapContext extends InitialDirContext, implements LdapContext
{
	...
	@:overload(function (environment:Hashtable<Dynamic, Dynamic>, connCtls:NativeArray<Control>):Void {})
	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/naming/ldap/InitialLdapContext.html#InitialLdapContext() */
	public function new():Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/naming/ldap/InitialLdapContext.html#close() */
	...
	public function newInstance(reqCtls:NativeArray<Control>):LdapContext;
