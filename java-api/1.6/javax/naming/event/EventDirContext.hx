...
extern interface EventDirContext implements EventContext, implements DirContext
{
	...
	@:overload(function (target:String, filter:String, filterArgs:NativeArray<Dynamic>, ctls:SearchControls, l:NamingListener):Void {})
	...
	@:overload(function (target:Name, filter:String, filterArgs:NativeArray<Dynamic>, ctls:SearchControls, l:NamingListener):Void {})
	...
	@:overload(function (target:String, filter:String, ctls:SearchControls, l:NamingListener):Void {})
	...
	public function addNamingListener(target:Name, filter:String, ctls:SearchControls, l:NamingListener):Void;
