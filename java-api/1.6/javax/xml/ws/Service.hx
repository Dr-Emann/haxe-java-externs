...
extern class Service extends Object
{
	...
	private function new(wsdlDocumentLocation:URL, serviceName:QName):Void;
	...
	@:overload(function (wsdlDocumentLocation:URL, serviceName:QName):Service {})
	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/xml/ws/Service.html#create(javax.xml.namespace.QName) */
	static public function create(serviceName:QName):Service;
