...
extern interface DomHandler<ElementT : (Dynamic), ResultT : (Result)>
{
	...
	public function createUnmarshaller(errorHandler:ValidationEventHandler):ResultT;
	...
	public function getElement(rt:ResultT):ElementT;
	...
	public function marshal(n:ElementT, errorHandler:ValidationEventHandler):Source;
