...
extern interface SSLSessionBindingListener implements EventListener
{
	...
	/*@@@ modifiers=1025 */ public function valueBound(arg0:SSLSessionBindingEvent):Void;
	...
	/*@@@ modifiers=1025 */ public function valueUnbound(arg0:SSLSessionBindingEvent):Void;
