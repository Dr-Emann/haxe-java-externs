...
extern interface X509TrustManager implements TrustManager
{
	...
	/*@@@ modifiers=1025 */ public function checkClientTrusted(arg0:NativeArray<X509Certificate>, arg1:String):Void;
	...
	/*@@@ modifiers=1025 */ public function checkServerTrusted(arg0:NativeArray<X509Certificate>, arg1:String):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/net/ssl/X509TrustManager.html#getAcceptedIssuers() */
	/*@@@ modifiers=1025 */ public function getAcceptedIssuers():NativeArray<X509Certificate>;
