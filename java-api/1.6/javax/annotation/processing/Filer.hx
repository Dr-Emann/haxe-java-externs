...
extern interface Filer
{
	...
	public function createClassFile(name:CharSequence, originatingElements:NativeArray<Element>):JavaFileObject;
	...
	public function createResource(location:JavaFileManager_Location, pkg:CharSequence, relativeName:CharSequence, originatingElements:NativeArray<Element>):FileObject;
	...
	public function createSourceFile(name:CharSequence, originatingElements:NativeArray<Element>):JavaFileObject;
	...
	public function getResource(location:JavaFileManager_Location, pkg:CharSequence, relativeName:CharSequence):FileObject;
