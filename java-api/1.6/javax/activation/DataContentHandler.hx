...
extern interface DataContentHandler
{
	...
	/*@@@ modifiers=1025 */ public function getContent(arg0:DataSource):Dynamic;
	...
	/*@@@ modifiers=1025 */ public function getTransferData(arg0:DataFlavor, arg1:DataSource):Dynamic;
	...
	/*@@@ modifiers=1025 */ public function writeTo(arg0:Dynamic, arg1:String, arg2:OutputStream):Void;
