...
extern interface Elements
{
	...
	public function getAllAnnotationMirrors(e:Element):List<AnnotationMirror>;
	...
	public function getAllMembers(type:TypeElement):List<Element>;
	...
	public function getDocComment(e:Element):String;
	...
	public function getPackageOf(type:Element):PackageElement;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/lang/model/util/Elements.html#getTypeElement(java.lang.CharSequence) */
	public function getTypeElement(name:CharSequence):TypeElement;
	...
	public function hides(hider:Element, hidden:Element):Bool;
	...
	public function isDeprecated(e:Element):Bool;
	...
	public function overrides(overrider:ExecutableElement, overridden:ExecutableElement, type:TypeElement):Bool;
	...
	public function printElements(w:Writer, elements:NativeArray<Element>):Void;
