...
extern class SimpleAnnotationValueVisitor6<R : (Dynamic), P : (Dynamic)> extends AbstractAnnotationValueVisitor6<R, P>
{
	...
	/*@@@ modifiers=1 */ override public function visitAnnotation(a:AnnotationMirror, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitArray(vals:List<AnnotationValue>, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitBoolean(b:Bool, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitByte(b:Int8, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitChar(c:Char16, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitDouble(d:StdFloat, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitEnumConstant(c:VariableElement, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitFloat(f:Single, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitInt(i:Int, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitLong(i:haxe.Int64, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitShort(s:Int16, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitString(s:String, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitType(t:TypeMirror, p:P):R;
