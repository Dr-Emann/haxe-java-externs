...
extern class SimpleTypeVisitor6<R : (Dynamic), P : (Dynamic)> extends AbstractTypeVisitor6<R, P>
{
	...
	/*@@@ modifiers=1 */ override public function visitArray(t:ArrayType, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitDeclared(t:DeclaredType, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitError(t:ErrorType, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitExecutable(t:ExecutableType, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitNull(t:NullType, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitTypeVariable(t:TypeVariable, p:P):R;
	...
	/*@@@ modifiers=1 */ override public function visitWildcard(t:WildcardType, p:P):R;
