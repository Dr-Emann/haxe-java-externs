...
extern interface ClassLoaderRepository
{
	...
	/*@@@ modifiers=1025 */ public function loadClass(className:String):Class<Dynamic>;
	...
	/*@@@ modifiers=1025 */ public function loadClassBefore(stop:ClassLoader, className:String):Class<Dynamic>;
	...
	/*@@@ modifiers=1025 */ public function loadClassWithout(exclude:ClassLoader, className:String):Class<Dynamic>;
