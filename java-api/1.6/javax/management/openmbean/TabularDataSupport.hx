...
extern class TabularDataSupport extends Object, implements TabularData, implements Map<Dynamic, Dynamic>, implements Cloneable, implements Serializable
{
	...
	/*@@@ modifiers=1 */ @:overload(function (key:Dynamic):Bool {})
	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/management/openmbean/TabularDataSupport.html#containsKey(java.lang.Object[]) */
	/*@@@ modifiers=1 */ public function containsKey(key:NativeArray<Dynamic>):Bool;
	...
	/*@@@ modifiers=1 */ @:overload(function (value:Dynamic):Bool {})
	...
	/*@@@ modifiers=1 */ public function containsValue(value:CompositeData):Bool;
	...
	/*@@@ modifiers=1 */ @:overload(function (key:Dynamic):Dynamic {})
	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/management/openmbean/TabularDataSupport.html#get(java.lang.Object[]) */
	/*@@@ modifiers=1 */ public function get(key:NativeArray<Dynamic>):CompositeData;
	...
	/*@@@ modifiers=1 */ @:overload(function (key:Dynamic, value:Dynamic):Dynamic {})
	...
	/*@@@ modifiers=1 */ public function put(value:CompositeData):Void;
	...
	/*@@@ modifiers=1 */ @:overload(function (key:Dynamic):Dynamic {})
	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/management/openmbean/TabularDataSupport.html#remove(java.lang.Object[]) */
	/*@@@ modifiers=1 */ public function remove(key:NativeArray<Dynamic>):CompositeData;
