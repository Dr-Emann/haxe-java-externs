...
extern class JMX extends Object
{
	...
	/*@@@ modifiers=9 */ static public function isMXBeanInterface(interfaceClass:Class<Dynamic>):Bool;
	...
	/*@@@ modifiers=9 */ @:overload(function <T>(connection:MBeanServerConnection, objectName:ObjectName, interfaceClass:Class<T>, notificationBroadcaster:Bool):T {})
	...
	/*@@@ modifiers=9 */ static public function newMBeanProxy<T>(connection:MBeanServerConnection, objectName:ObjectName, interfaceClass:Class<T>):T;
	...
	/*@@@ modifiers=9 */ static public function newMXBeanProxy<T>(connection:MBeanServerConnection, objectName:ObjectName, interfaceClass:Class<T>):T;
