...
extern class AttributeList extends ArrayList<Dynamic>
{
	...
	/*@@@ modifiers=1 */ @:overload(function (object:Attribute):Void {})
	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/management/AttributeList.html#add(java.lang.Object) */
	/*@@@ modifiers=1 */ override public function add(o:Dynamic):Bool;
	...
	/*@@@ modifiers=1 */ @:overload(function (list:AttributeList):Bool {})
