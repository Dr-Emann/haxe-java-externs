...
extern class JMXConnectorFactory extends Object
{
	...
	@:overload(function (serviceURL:JMXServiceURL, environment:Map<String, Dynamic>):JMXConnector {})
	...
	static public function connect(serviceURL:JMXServiceURL):JMXConnector;
	...
	static public function newJMXConnector(serviceURL:JMXServiceURL, environment:Map<String, Dynamic>):JMXConnector;
