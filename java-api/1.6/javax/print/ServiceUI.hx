...
extern class ServiceUI extends Object
{
	...
	static public function printDialog(gc:GraphicsConfiguration, x:Int, y:Int, services:NativeArray<PrintService>, defaultService:PrintService, flavor:DocFlavor, attributes:PrintRequestAttributeSet):PrintService;
