...
/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/TransferHandler.HasGetTransferHandler.html */
@:native("javax.swing.TransferHandler.HasGetTransferHandler")
