...
extern class SwingUtilities extends Object, implements SwingConstants
{
	...
	static public function calculateInnerArea(c:JComponent, r:Rectangle):Rectangle;
	...
	static public function computeDifference(rectA:Rectangle, rectB:Rectangle):NativeArray<Rectangle>;
	...
	static public function computeIntersection(x:Int, y:Int, width:Int, height:Int, dest:Rectangle):Rectangle;
	...
	static public function computeStringWidth(fm:FontMetrics, str:String):Int;
	...
	static public function computeUnion(x:Int, y:Int, width:Int, height:Int, dest:Rectangle):Rectangle;
	...
	static public function convertMouseEvent(source:Component, sourceEvent:MouseEvent, destination:Component):MouseEvent;
	...
	@:overload(function (source:Component, x:Int, y:Int, destination:Component):Point {})
	...
	static public function convertPoint(source:Component, aPoint:Point, destination:Component):Point;
	...
	static public function convertPointFromScreen(p:Point, c:Component):Void;
	...
	static public function convertPointToScreen(p:Point, c:Component):Void;
	...
	static public function convertRectangle(source:Component, aRectangle:Rectangle, destination:Component):Rectangle;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/SwingUtilities.html#findFocusOwner(java.awt.Component) */
	static public function findFocusOwner(c:Component):Component;
	...
	static public function getAncestorNamed(name:String, comp:Component):Container;
	...
	static public function getAncestorOfClass(c:Class<Dynamic>, comp:Component):Container;
	...
	static public function getDeepestComponentAt(parent:Component, x:Int, y:Int):Component;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/SwingUtilities.html#getLocalBounds(java.awt.Component) */
	static public function getLocalBounds(aComponent:Component):Rectangle;
	...
	static public function isRectangleContainingRectangle(a:Rectangle, b:Rectangle):Bool;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/SwingUtilities.html#isRightMouseButton(java.awt.event.MouseEvent) */
	static public function isRightMouseButton(anEvent:MouseEvent):Bool;
	...
	@:overload(function (c:JComponent, fm:FontMetrics, text:String, icon:Icon, verticalAlignment:Int, horizontalAlignment:Int, verticalTextPosition:Int, horizontalTextPosition:Int, viewR:Rectangle, iconR:Rectangle, textR:Rectangle, textIconGap:Int):String {})
	...
	static public function layoutCompoundLabel(fm:FontMetrics, text:String, icon:Icon, verticalAlignment:Int, horizontalAlignment:Int, verticalTextPosition:Int, horizontalTextPosition:Int, viewR:Rectangle, iconR:Rectangle, textR:Rectangle, textIconGap:Int):String;
	...
	static public function notifyAction(action:Action, ks:KeyStroke, event:KeyEvent, sender:Dynamic, modifiers:Int):Bool;
	...
	static public function paintComponent(g:Graphics, c:Component, p:Container, r:Rectangle):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/SwingUtilities.html#processKeyBindings(java.awt.event.KeyEvent) */
	static public function processKeyBindings(event:KeyEvent):Bool;
	...
	static public function replaceUIActionMap(component:JComponent, uiActionMap:ActionMap):Void;
