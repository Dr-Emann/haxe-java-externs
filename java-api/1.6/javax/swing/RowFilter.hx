...
extern class RowFilter<M : (Dynamic), I : (Dynamic)> extends Object
{
	...
	static public function andFilter<M, I>(filters:java.lang.Iterable<RowFilter<Dynamic, Dynamic>>):RowFilter<M, I>;
	...
	static public function dateFilter<M, I>(type:RowFilter_ComparisonType, date:Date, indices:NativeArray<Int>):RowFilter<M, I>;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/RowFilter.html#include(javax.swing.RowFilter$Entry) */
	public function include(entry:RowFilter_Entry<M, I>):Bool;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/RowFilter.html#notFilter(javax.swing.RowFilter) */
	static public function notFilter<M, I>(filter:RowFilter<M, I>):RowFilter<M, I>;
	...
	static public function numberFilter<M, I>(type:RowFilter_ComparisonType, number:Number, indices:NativeArray<Int>):RowFilter<M, I>;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/RowFilter.html#orFilter(java.lang.Iterable) */
	static public function orFilter<M, I>(filters:java.lang.Iterable<RowFilter<Dynamic, Dynamic>>):RowFilter<M, I>;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/RowFilter.html#regexFilter(java.lang.String, int[]) */
	static public function regexFilter<M, I>(regex:String, indices:NativeArray<Int>):RowFilter<M, I>;
