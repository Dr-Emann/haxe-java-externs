...
extern class ZoneView extends BoxView
{
	...
	private function isZoneLoaded(zone:View):Bool;
	...
	override private function updateChildren(ec:DocumentEvent_ElementChange, e:DocumentEvent, f:ViewFactory):Bool;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/text/ZoneView.html#zoneWasLoaded(javax.swing.text.View) */
	private function zoneWasLoaded(zone:View):Void;
