...
extern class DefaultHighlighter extends LayeredHighlighter
{
	...
	/*@@@ modifiers=1 */ public function addHighlight(p0:Int, p1:Int, p:Highlighter_HighlightPainter):Dynamic;
	...
	/*@@@ modifiers=1 */ public function changeHighlight(tag:Dynamic, p0:Int, p1:Int):Void;
	...
	/*@@@ modifiers=1 */ public function getHighlights():NativeArray<Highlighter_Highlight>;
