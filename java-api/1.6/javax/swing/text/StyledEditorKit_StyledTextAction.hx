...
extern class StyledEditorKit_StyledTextAction extends TextAction
{
	...
	public function new(nm:String):Void;
	...
	private function getEditor(e:ActionEvent):JEditorPane;
	...
	private function getStyledDocument(e:JEditorPane):StyledDocument;
	...
	private function getStyledEditorKit(e:JEditorPane):StyledEditorKit;
	...
	private function setCharacterAttributes(editor:JEditorPane, attr:AttributeSet, replace:Bool):Void;
	...
	private function setParagraphAttributes(editor:JEditorPane, attr:AttributeSet, replace:Bool):Void;
