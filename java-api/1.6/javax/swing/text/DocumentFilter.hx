...
extern class DocumentFilter extends Object
{
	...
	public function insertString(fb:DocumentFilter_FilterBypass, offset:Int, string:String, attr:AttributeSet):Void;
	...
	public function remove(fb:DocumentFilter_FilterBypass, offset:Int, length:Int):Void;
	...
	public function replace(fb:DocumentFilter_FilterBypass, offset:Int, length:Int, text:String, attrs:AttributeSet):Void;
