...
extern class HTMLEditorKit_InsertHTMLTextAction extends HTMLEditorKit_HTMLTextAction
{
	...
	@:overload(function (name:String, html:String, parentTag:HTML_Tag, addTag:HTML_Tag, alternateParentTag:HTML_Tag, alternateAddTag:HTML_Tag):Void {})
	...
	public function new(name:String, html:String, parentTag:HTML_Tag, addTag:HTML_Tag):Void;
	...
	private function insertAtBoundary(editor:JEditorPane, doc:HTMLDocument, offset:Int, insertElement:Element, html:String, parentTag:HTML_Tag, addTag:HTML_Tag):Void;
	...
	private function insertAtBoundry(editor:JEditorPane, doc:HTMLDocument, offset:Int, insertElement:Element, html:String, parentTag:HTML_Tag, addTag:HTML_Tag):Void;
	...
	private function insertHTML(editor:JEditorPane, doc:HTMLDocument, offset:Int, html:String, popDepth:Int, pushDepth:Int, addTag:HTML_Tag):Void;
