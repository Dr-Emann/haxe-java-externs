...
extern class NavigationFilter extends Object
{
	...
	/*@@@ modifiers=1 */ public function getNextVisualPositionFrom(text:JTextComponent, pos:Int, bias:Position_Bias, direction:Int, biasRet:NativeArray<Position_Bias>):Int;
	...
	/*@@@ modifiers=1 */ public function moveDot(fb:NavigationFilter_FilterBypass, dot:Int, bias:Position_Bias):Void;
	...
	/*@@@ modifiers=1 */ public function setDot(fb:NavigationFilter_FilterBypass, dot:Int, bias:Position_Bias):Void;
