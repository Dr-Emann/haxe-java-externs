...
extern class Utilities extends Object
{
	...
	static public function drawTabbedText(s:Segment, x:Int, y:Int, g:Graphics, e:TabExpander, startOffset:Int):Int;
	...
	static public function getBreakLocation(s:Segment, metrics:FontMetrics, x0:Int, x:Int, e:TabExpander, startOffset:Int):Int;
	...
	static public function getNextWord(c:JTextComponent, offs:Int):Int;
	...
	static public function getParagraphElement(c:JTextComponent, offs:Int):Element;
	...
	static public function getPositionAbove(c:JTextComponent, offs:Int, x:Int):Int;
	...
	static public function getPositionBelow(c:JTextComponent, offs:Int, x:Int):Int;
	...
	static public function getPreviousWord(c:JTextComponent, offs:Int):Int;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/text/Utilities.html#getRowEnd(javax.swing.text.JTextComponent, int) */
	static public function getRowEnd(c:JTextComponent, offs:Int):Int;
	...
	static public function getRowStart(c:JTextComponent, offs:Int):Int;
	...
	@:overload(function (s:Segment, metrics:FontMetrics, x0:Int, x:Int, e:TabExpander, startOffset:Int, round:Bool):Int {})
	...
	static public function getTabbedTextOffset(s:Segment, metrics:FontMetrics, x0:Int, x:Int, e:TabExpander, startOffset:Int):Int;
	...
	static public function getTabbedTextWidth(s:Segment, metrics:FontMetrics, x:Int, e:TabExpander, startOffset:Int):Int;
	...
	static public function getWordEnd(c:JTextComponent, offs:Int):Int;
	...
	static public function getWordStart(c:JTextComponent, offs:Int):Int;
