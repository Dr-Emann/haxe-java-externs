...
extern class TreeModelEvent extends EventObject
{
	...
	@:overload(function (source:Dynamic, path:TreePath, childIndices:NativeArray<Int>, children:NativeArray<Dynamic>):Void {})
	...
	@:overload(function (source:Dynamic, path:NativeArray<Dynamic>):Void {})
	...
	@:overload(function (source:Dynamic, path:TreePath):Void {})
	...
	public function new(source:Dynamic, path:NativeArray<Dynamic>, childIndices:NativeArray<Int>, children:NativeArray<Dynamic>):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/event/TreeModelEvent.html#getChildIndices() */
	public function getChildIndices():NativeArray<Int>;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/event/TreeModelEvent.html#getChildren() */
	public function getChildren():NativeArray<Dynamic>;
