...
extern interface AncestorListener implements EventListener
{
	...
	public function ancestorAdded(event:AncestorEvent):Void;
	...
	public function ancestorMoved(event:AncestorEvent):Void;
	...
	public function ancestorRemoved(event:AncestorEvent):Void;
