...
extern class TreeSelectionEvent extends EventObject
{
	...
	@:overload(function (source:Dynamic, paths:TreePath, areNew:Bool, oldLeadSelectionPath:TreePath, newLeadSelectionPath:TreePath):Void {})
	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/event/TreeSelectionEvent.html#TreeSelectionEvent(java.lang.Object, javax.swing.tree.TreePath[], boolean[], javax.swing.tree.TreePath, javax.swing.tree.TreePath) */
	public function new(source:Dynamic, paths:NativeArray<TreePath>, areNew:NativeArray<Bool>, oldLeadSelectionPath:TreePath, newLeadSelectionPath:TreePath):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/event/TreeSelectionEvent.html#cloneWithSource(java.lang.Object) */
	public function cloneWithSource(newSource:Dynamic):Dynamic;
	...
	public function getPaths():NativeArray<TreePath>;
	...
	@:overload(function (path:TreePath):Bool {})
