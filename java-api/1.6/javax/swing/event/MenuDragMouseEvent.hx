...
extern class MenuDragMouseEvent extends MouseEvent
{
	...
	/*@@@ modifiers=1 */ @:overload(function (source:Component, id:Int, when:haxe.Int64, modifiers:Int, x:Int, y:Int, clickCount:Int, popupTrigger:Bool, p:NativeArray<MenuElement>, m:MenuSelectionManager):Void {})
	...
	/*@@@ modifiers=1 */ public function new(source:Component, id:Int, when:haxe.Int64, modifiers:Int, x:Int, y:Int, xAbs:Int, yAbs:Int, clickCount:Int, popupTrigger:Bool, p:NativeArray<MenuElement>, m:MenuSelectionManager):Void;
