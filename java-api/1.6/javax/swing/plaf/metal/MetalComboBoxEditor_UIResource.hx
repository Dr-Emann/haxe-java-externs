...
/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/plaf/metal/MetalComboBoxEditor.UIResource.html */
@:native("javax.swing.plaf.metal.MetalComboBoxEditor.UIResource")
