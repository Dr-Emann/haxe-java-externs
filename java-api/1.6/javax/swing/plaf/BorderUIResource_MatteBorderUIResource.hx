...
extern class BorderUIResource_MatteBorderUIResource extends MatteBorder, implements UIResource
{
	...
	/*@@@ modifiers=1 */ @:overload(function (top:Int, left:Int, bottom:Int, right:Int, color:Color):Void {})
	...
	/*@@@ modifiers=1 */ @:overload(function (top:Int, left:Int, bottom:Int, right:Int, color:Icon):Void {})
	...
	/*@@@ modifiers=1 */ public function new(tileIcon:Icon):Void;
