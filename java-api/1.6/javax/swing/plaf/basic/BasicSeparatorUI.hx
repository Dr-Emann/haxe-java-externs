...
extern class BasicSeparatorUI extends SeparatorUI
{
	...
	private function installDefaults(s:JSeparator):Void;
	...
	private function installListeners(s:JSeparator):Void;
	...
	private function uninstallDefaults(s:JSeparator):Void;
	...
	private function uninstallListeners(s:JSeparator):Void;
