...
extern class BasicGraphicsUtils extends Object
{
	...
	/*@@@ modifiers=9 */ static public function drawBezel(g:Graphics, x:Int, y:Int, w:Int, h:Int, isPressed:Bool, isDefault:Bool, shadow:Color, darkShadow:Color, highlight:Color, lightHighlight:Color):Void;
	...
	/*@@@ modifiers=9 */ static public function drawDashedRect(g:Graphics, x:Int, y:Int, width:Int, height:Int):Void;
	...
	/*@@@ modifiers=9 */ static public function drawEtchedRect(g:Graphics, x:Int, y:Int, w:Int, h:Int, shadow:Color, darkShadow:Color, highlight:Color, lightHighlight:Color):Void;
	...
	/*@@@ modifiers=9 */ static public function drawGroove(g:Graphics, x:Int, y:Int, w:Int, h:Int, shadow:Color, highlight:Color):Void;
	...
	/*@@@ modifiers=9 */ static public function drawLoweredBezel(g:Graphics, x:Int, y:Int, w:Int, h:Int, shadow:Color, darkShadow:Color, highlight:Color, lightHighlight:Color):Void;
	...
	/*@@@ modifiers=9 */ static public function drawString(g:Graphics, text:String, underlinedChar:Int, x:Int, y:Int):Void;
	...
	/*@@@ modifiers=9 */ static public function drawStringUnderlineCharAt(g:Graphics, text:String, underlinedIndex:Int, x:Int, y:Int):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/plaf/basic/BasicGraphicsUtils.html#getEtchedInsets() */
	/*@@@ modifiers=9 */ static public function getEtchedInsets():Insets;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/plaf/basic/BasicGraphicsUtils.html#getGrooveInsets() */
	/*@@@ modifiers=9 */ static public function getGrooveInsets():Insets;
	...
	/*@@@ modifiers=9 */ static public function getPreferredButtonSize(b:AbstractButton, textIconGap:Int):Dimension;
