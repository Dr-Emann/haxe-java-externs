...
extern class MultiTreeUI extends TreeUI
{
	...
	override public function cancelEditing(a:JTree):Void;
	...
	override public function getClosestPathForLocation(a:JTree, b:Int, c:Int):TreePath;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/plaf/multi/MultiTreeUI.html#getEditingPath(javax.swing.JTree) */
	override public function getEditingPath(a:JTree):TreePath;
	...
	override public function getPathBounds(a:JTree, b:TreePath):Rectangle;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/plaf/multi/MultiTreeUI.html#getPathForRow(javax.swing.JTree, int) */
	override public function getPathForRow(a:JTree, b:Int):TreePath;
	...
	override public function getRowCount(a:JTree):Int;
	...
	override public function getRowForPath(a:JTree, b:TreePath):Int;
	...
	override public function isEditing(a:JTree):Bool;
	...
	override public function startEditingAtPath(a:JTree, b:TreePath):Void;

	/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/plaf/multi/MultiTreeUI.html#stopEditing(javax.swing.JTree) */
	override public function stopEditing(a:JTree):Bool;
