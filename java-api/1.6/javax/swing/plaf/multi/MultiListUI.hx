...
extern class MultiListUI extends ListUI
{
	...
	/*@@@ modifiers=1 */ override public function getCellBounds(a:JList, b:Int, c:Int):Rectangle;
	...
	/*@@@ modifiers=1 */ override public function indexToLocation(a:JList, b:Int):Point;
	...
	/*@@@ modifiers=1 */ override public function locationToIndex(a:JList, b:Point):Int;
