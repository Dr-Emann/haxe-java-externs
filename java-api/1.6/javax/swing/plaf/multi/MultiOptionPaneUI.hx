...
extern class MultiOptionPaneUI extends OptionPaneUI
{
	...
	/*@@@ modifiers=1 */ override public function containsCustomComponents(a:JOptionPane):Bool;
	...
	/*@@@ modifiers=1 */ override public function selectInitialValue(a:JOptionPane):Void;
