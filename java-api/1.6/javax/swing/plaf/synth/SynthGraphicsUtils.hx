...
extern class SynthGraphicsUtils extends Object
{
	...
	/*@@@ modifiers=1 */ public function computeStringWidth(ss:SynthContext, font:Font, metrics:FontMetrics, text:String):Int;
	...
	/*@@@ modifiers=1 */ @:overload(function (context:SynthContext, paintKey:Dynamic, g:Graphics, x1:Int, y1:Int, x2:Int, y2:Int, styleKey:Dynamic):Void {})
	...
	/*@@@ modifiers=1 */ public function drawLine(context:SynthContext, paintKey:Dynamic, g:Graphics, x1:Int, y1:Int, x2:Int, y2:Int):Void;
	...
	/*@@@ modifiers=1 */ public function getMaximumCharHeight(context:SynthContext):Int;
	...
	/*@@@ modifiers=1 */ public function getMaximumSize(ss:SynthContext, font:Font, text:String, icon:Icon, hAlign:Int, vAlign:Int, hTextPosition:Int, vTextPosition:Int, iconTextGap:Int, mnemonicIndex:Int):Dimension;
	...
	/*@@@ modifiers=1 */ public function getMinimumSize(ss:SynthContext, font:Font, text:String, icon:Icon, hAlign:Int, vAlign:Int, hTextPosition:Int, vTextPosition:Int, iconTextGap:Int, mnemonicIndex:Int):Dimension;
	...
	/*@@@ modifiers=1 */ public function getPreferredSize(ss:SynthContext, font:Font, text:String, icon:Icon, hAlign:Int, vAlign:Int, hTextPosition:Int, vTextPosition:Int, iconTextGap:Int, mnemonicIndex:Int):Dimension;
	...
	/*@@@ modifiers=1 */ public function layoutText(ss:SynthContext, fm:FontMetrics, text:String, icon:Icon, hAlign:Int, vAlign:Int, hTextPosition:Int, vTextPosition:Int, viewR:Rectangle, iconR:Rectangle, textR:Rectangle, iconTextGap:Int):String;
	...
	/*@@@ modifiers=1 */ @:overload(function (ss:SynthContext, g:Graphics, text:String, icon:Icon, hAlign:Int, vAlign:Int, hTextPosition:Int, vTextPosition:Int, iconTextGap:Int, mnemonicIndex:Int, textOffset:Int):Void {})
	...
	/*@@@ modifiers=1 */ @:overload(function (ss:SynthContext, g:Graphics, text:String, x:Int, y:Int, mnemonicIndex:Int):Void {})
	...
	/*@@@ modifiers=1 */ public function paintText(ss:SynthContext, g:Graphics, text:String, bounds:Rectangle, mnemonicIndex:Int):Void;
