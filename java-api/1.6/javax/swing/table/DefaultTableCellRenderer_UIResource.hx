...
/** @REF http://docs.oracle.com/javase/6/docs/api/javax/swing/table/DefaultTableCellRenderer.UIResource.html */
@:native("javax.swing.table.DefaultTableCellRenderer.UIResource")
