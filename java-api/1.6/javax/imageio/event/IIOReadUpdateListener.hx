...
extern interface IIOReadUpdateListener implements EventListener
{
	...
	public function imageUpdate(source:ImageReader, theImage:BufferedImage, minX:Int, minY:Int, width:Int, height:Int, periodX:Int, periodY:Int, bands:NativeArray<Int>):Void;
	...
	public function passComplete(source:ImageReader, theImage:BufferedImage):Void;
	...
	public function passStarted(source:ImageReader, theImage:BufferedImage, pass:Int, minPass:Int, maxPass:Int, minX:Int, minY:Int, periodX:Int, periodY:Int, bands:NativeArray<Int>):Void;
	...
	public function thumbnailPassComplete(source:ImageReader, theThumbnail:BufferedImage):Void;
	...
	public function thumbnailPassStarted(source:ImageReader, theThumbnail:BufferedImage, pass:Int, minPass:Int, maxPass:Int, minX:Int, minY:Int, periodX:Int, periodY:Int, bands:NativeArray<Int>):Void;
	...
	public function thumbnailUpdate(source:ImageReader, theThumbnail:BufferedImage, minX:Int, minY:Int, width:Int, height:Int, periodX:Int, periodY:Int, bands:NativeArray<Int>):Void;
