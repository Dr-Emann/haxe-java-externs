...
extern interface LSParser
{
	...
	public function getFilter():LSParserFilter;
	...
	public function parseWithContext(input:LSInput, contextArg:Node, action:Int16):Node;

	/** @REF http://docs.oracle.com/javase/6/docs/api/org/w3c/dom/ls/LSParser.html#setFilter(org.w3c.dom.ls.LSParserFilter) */
	public function setFilter(filter:LSParserFilter):Void;
