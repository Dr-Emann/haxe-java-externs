...
extern interface DOMImplementation
{
	...
	/*@@@ modifiers=1025 */ public function createDocument(namespaceURI:String, qualifiedName:String, doctype:DocumentType):Document;
	...
	/*@@@ modifiers=1025 */ public function createDocumentType(qualifiedName:String, publicId:String, systemId:String):DocumentType;
	...
	/*@@@ modifiers=1025 */ public function hasFeature(feature:String, version:String):Bool;
